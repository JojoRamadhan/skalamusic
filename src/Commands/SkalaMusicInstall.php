...
namespace Jojoramadhan\Skalamusic\Commands;

use App\User;
use Illuminate\Console\Command;
use Jojoramadhan\Skalamusic\Models\Menu;
use Jojoramadhan\Skalamusic\Models\Role;

class SkalaMusicInstall extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'skalamusic:install';
     ...
     * @var string
     */
    protected $description = 'Run installation of SkalaMusic.';
    ...
    {
        $this->info('Please note: SkalaMusic requires fresh Laravel installation!');
        $this->info('Starting installation process of SkalaMusic...');
