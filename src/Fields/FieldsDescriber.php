<?php
namespace Jojoramadhan\Skalamusic\Fields;

class FieldsDescriber
{
    /**
     * Default SkalaMusic field types
     * @return array
     */
    ...
    /**
     * Default skalamusic field validation types
     * @return array
     */
    public static function validation()
    {
        return [
            'optional'        => trans('skalamusic::strings.optional'),
            'required'        => trans('skalamusic::strings.required'),
            'required|unique' => trans('skalamusic::strings.required_unique')
        ];
    }
    ...
    /**
     * Default SkalaMusic field types for migration
     * @return array
     */
    ...
    /**
     * Default SkalaMusic state for checkbox
     * @return array
     */
    public static function default_cbox()
    {
        return [
            'false' => trans('skalamusic::strings.default_unchecked'),
            'true'  => trans('skalamusic::strings.default_checked'),
        ];
    }
}