...
use Jojoramadhan\Skalamusic\Builders\ControllerBuilder;
use Jojoramadhan\Skalamusic\Builders\MigrationBuilder;
use Jojoramadhan\Skalamusic\Builders\ModelBuilder;
use Jojoramadhan\Skalamusic\Builders\RequestBuilder;
use Jojoramadhan\Skalamusic\Builders\ViewsBuilder;
use Jojoramadhan\Skalamusic\Cache\QuickCache;
use Jojoramadhan\Skalamusic\Fields\FieldsDescriber;
use Jojoramadhan\Skalamusic\Models\Menu;

class SkalamusicMenuController extends Controller
{

    /**
     * Skalamusic menu list page
    ...
    /**
     * Rearrange skalamusic menu items
     *
...
//        dd($fields);
        ...
        return redirect(config('skalamusic.route'));
    }
