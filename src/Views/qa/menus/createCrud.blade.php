...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-10 col-sm-offset-2">
            <h1>{{ trans('skalamusic::qa.menus-createCrud-create_new_crud') }}</h1>
    ...
    <div class="form-group">
        {!! Form::label('parent_id', trans('skalamusic::qa.menus-createCrud-crud_parent'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {!! Form::label('name', trans('skalamusic::qa.menus-createCrud-crud_name'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::text('name', old('name'), ['class'=>'form-control', 'placeholder'=> trans('skalamusic::qa.menus-createCrud-crud_name_placeholder')]) !!}
        </div>
    </div>

    <div class="form-group">
        {!! Form::label('title', trans('skalamusic::qa.menus-createCrud-crud_title'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::text('title', old('title'), ['class'=>'form-control', 'placeholder'=> trans('skalamusic::qa.menus-createCrud-crud_title_placeholder')]) !!}
        </div>
    </div>

    <div class="form-group">
        {!! Form::label('roles', trans('skalamusic::qa.menus-createCrud-roles'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
    ...
    <div class="form-group">
        {!! Form::label('soft', trans('skalamusic::qa.menus-createCrud-soft_delete'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::select('soft', [1 => trans('skalamusic::strings.yes'), 0 => trans('skalamusic::strings.no')], old('soft'), ['class' => 'form-control']) !!}
        </div>
    </div>

    <div class="form-group">
        {!! Form::label('icon', trans('skalamusic::qa.menus-createCrud-icon'), ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::text('icon', old('icon','fa-database'), ['class'=>'form-control', 'placeholder'=> trans('skalamusic::qa.menus-createCrud-icon_placeholder')]) !!}
        </div>
    </div>

    <hr/>

    <h3>{{ trans('skalamusic::qa.menus-createCrud-add_fields') }}</h3>

    <table class="table">
        <tbody id="generator">
            <tr>
                <td>{{ trans('skalamusic::qa.menus-createCrud-show_in_list') }}</td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
    ...
    <div class="form-group">
        <div class="col-md-12">
            <button type="button" id="addField" class="btn btn-success"><i
                        class="fa fa-plus"></i> {{ trans('skalamusic::qa.menus-createCrud-add_field') }}
            </button>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-md-12">
            {!! Form::submit(trans('skalamusic::qa.menus-createCrud-create_crud'), ['class' => 'btn btn-primary']) !!}
        </div>
    </div>
    ...
    <div style="display: none;">
        ...
        @foreach($models as $key => $model)
            <select name="f_relationship_field[{{ $key }}]" class="form-control relationship-field rf-{{ $key }}">
                <option value="">{{ trans('skalamusic::qa.menus-createCrud-select_display_field') }}</option>
