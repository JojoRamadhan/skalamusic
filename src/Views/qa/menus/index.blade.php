...
@section('content')
        ...
        <div class="row">
            <div class="col-xs-6 col-md-4">
                <div class="alert alert-info">
                    {{ trans('skalamusic::qa.menus-index-no_menu_items_found') }}
                </div>
            </div>
        </div>
    @endif
    ...
    <div class="row">
        <div class="col-xs-12 form-group">
            <a href="{{ route('menu.crud') }}" class="btn btn-primary">{{ trans('skalamusic::qa.menus-index-new_crud') }}</a>
            <a href="{{ route('menu.custom') }}" class="btn btn-primary">{{ trans('skalamusic::qa.menus-index-new_custom') }}</a>
            <a href="{{ route('menu.parent') }}" class="btn btn-primary">{{ trans('skalamusic::qa.menus-index-new_parent') }}</a>
        </div>
    </div>
    ...
    @if($menusList->count() != 0)
        <div class="row">
            <div class="col-xs-6 col-md-4">
                <div class="alert alert-danger">
                    {{ trans('skalamusic::qa.menus-index-positions_drag_drop') }}
                </div>
            </div>
        </div>
    @endif
    ...
    @if($menusList->count() != 0)
        ...
        <div class="row" id="dragMessage" style="display: none;">
            <div class="col-xs-6 col-md-4">
                <div class="alert alert-danger">
                    {{ trans('skalamusic::qa.menus-index-click_save_positions') }}
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
                {!! Form::submit(trans('skalamusic::qa.menus-index-save_positions'),['class' => 'btn btn-danger']) !!}
            </div>
        </div>
    @endif
